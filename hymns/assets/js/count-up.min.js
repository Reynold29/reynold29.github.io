function counterUp(t) {
  ...
  counterUp.prototype.update = function() {
    ...
    this.elems.forEach(function(e) {
      e.val += e.step;
      e.val < e.end ? (1 == e.intvalues ? e.obj.innerHTML = e.prepend + Math.floor(e.val).toString() + e.append : e.obj.innerHTML = e.prepend + Math.round(e.val).toString() + e.append, t = !1) : e.obj.innerHTML = e.prepend + e.end.toString() + e.append;
    });
